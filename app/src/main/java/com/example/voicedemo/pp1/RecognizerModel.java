package com.example.voicedemo.pp1;
...
public class RecognizerModel {
    ...
    public void setupSpeechRecognizer(Context context) {
        ...
        Log.d("flag","context="+context);
        Log.d("flag","context="+mInitListener);
        Log.d("flag","mRecognizer="+mRecognizer);
        mContext = context;
...
//        assets目录下获取语音文件
        final byte[] audioData = FileUtil2.readAudioFile(mContext, "name.wav");
        //通过sdcard获取语音文件
